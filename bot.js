...
const token = 'xoxb-495912072293-597659392467-XdbubDVVvYqZC1nO9UUGBEMv';
...
controller.hears(['출근'], botScope, (bot, replyMessage) => {
  ...
  schedule.scheduleJob({hour: quittingHour-9, minute: parseInt(quittingMinute)+1}, () => { // test용 메소드
    bot.reply(replyMessage,"퇴근 시간입니다.");
  });
});

// rtm.on(RTM_EVENTS.MESSAGE, (message)=> {
//   schedule.scheduleJob({hour: quittingHour, minute: parseInt(quittingMinute)}, () => {
//     rtm.sendMessage("퇴근 시간입니다.", 'DHX4V8TG8');
//   });
// });